    ...
    <div class="flex flex-col gap-8">
      ...
      <div class="container flex flex-col gap-4">
        <section class="flex flex-col gap-4">
          ...
          <p>
            At Bytebury, we're not just writing code; we're crafting solutions.
            We understand that software isn't just a tool; it's a gateway to
            transformation. With a passion for technology and a commitment to
            excellence, we're your trusted partner in bringing your digital
            dreams to life.
          </p>
        </section>
        <section class="flex flex-col gap-4">
          <h1 class="text-2xl sm:text-3xl">Our Commitment to You</h1>
          <ul>
            <li>
            ...
            <li>
              ...
              We work closely with you to ensure we're on the same page every
              step of the way.
            </li>
          </ul>
        </section>
        <section class="flex flex-col gap-4">
          <h1 class="text-2xl sm:text-3xl">Our Expertise</h1>
          We have over a decade's worth of experience under our belt, and
          projects that serve thousands.
        </section>
        <section class="flex flex-col gap-4">
          <h1 class="text-2xl sm:text-3xl">Byte Back with Us</h1>
          ...
          opportunities. With us, you're not just getting software; you're
          getting a digital future.
        </section>
      </div>
    </div>
  );
